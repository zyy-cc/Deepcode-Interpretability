# interpretable encoder 7 + original decoder based on 7/5 hidden states
# noiseless feedback
import numpy as np
import torch
...
identity = 'interenc7_deepdec7_snr0'
print('[ID]', identity)
...
def get_args(jupyter_notebook):
    ...
    parser.add_argument('-dec_num_unit', type=int, default=7) # 5
...
class AE(torch.nn.Module): 
    def __init__(self, args):
        ...
        # Encoder
        self.e = torch.nn.Parameter(torch.rand(3), requires_grad = True)
...
args.initial_weights = 'weight/model_interenc7_deepdec7.pt'
# args.initial_weights = 'weight/interenc7_deepdec7.pt'
