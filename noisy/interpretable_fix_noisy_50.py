# Interpretable model with fixed knee points
# noisy feedback 
"""
h4 = 1
h5 = -1
...
identity = 'interpretable_snr0_fbsnr20_50'
print('[ID]', identity)
...
def validation(model, device, X_validation, forward_noise_validation, feedback_noise_validation):
    ...
    # The dimension of the interpretable model output is 50.
    # remove the zero padding of X_validation
...
args.initial_weights = 'weight/model_interpretable_fix_snr0_fbsnr20_50.pt'
